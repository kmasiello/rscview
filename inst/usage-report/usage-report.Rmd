...
content_tbl_lang <- content_info_tbl %>% select(guid, name, title, r_version, py_version, content_category) %>% 
...
content_lang_tree <- content_tbl_lang %>% d3_nest(value_cols = c("language", "version"))

sund2b(content_lang_tree, 
       valueField = "language", 
       # colors = my_colors, 
       rootLabel = "Language", 
       width = "100%",
