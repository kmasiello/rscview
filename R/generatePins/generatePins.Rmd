...
pin_users <- pins::pin(df_users, name = "user-info", description = "Results pulled from `connectapi::get_users()`", board = "rsconnect")
# tag it
set_content_tag_tree(pin_users, tag_parent, tag_name)
```
...
# content_list2 <- get_content(client, limit = Inf)
```
